...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_open_detail){
            ...
            detailIntent.putExtra(DetailActivity.EXTRA_TITLE,
                    "Hola, Good news");
            detailIntent.putExtra(DetailActivity.EXTRA_MESSAGE,
                    "Now you can learn Android in ");
            detailIntent.putExtra(DetailActivity.EXTRA_MESSAGE,
                    "Now you can learn Android in Dicoding");
    ...
    private class DelayAsync extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPostExecute (Void aVoid){
            ...
            showNotification(MainActivity.this, "Hi How are you?",
                    " Do you have any plan this weekend? Let's Hangout", 100);
    ...
    private void showNotification(Context context, String title, String message, int notifId){
        ...
        PendingIntent mpendingIntent = TaskStackBuilder.create(this)
